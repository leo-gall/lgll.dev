<template>
  ...
  >
    ...
    <div class="flex flex-row gap-6">
      ...
      <NuxtLink
        to="https://bsky.app/profile/leogall.bsky.social"
        target="_blank"
        v-tooltip="`leogall`"
        data-umami-event="social-redirect-bluesky"
        aria-label="go to Leo Gall's BlueSky profile"
      >
        <svg fill="none" viewBox="0 0 64 57" width="30px" height="30px">
          <path
            fill="#fff"
      ...
      <NuxtLink
        to="https://www.twitch.tv/lglldev"
        target="_blank"
        v-tooltip="`lglldev`"
        data-umami-event="social-redirect-twitch"
        aria-label="go to Leo Gall's Twitch channel"
      >
        <svg
          width="30px"
          height="30px"
